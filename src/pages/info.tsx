            ...
            <div className="mx-4 flex flex-col gap-6 divide-y divide-slate-700 sm:mx-6">
              <div id="creating-workouts">
                <div className="mx-auto flex max-w-sm flex-col gap-4 pt-6">
                  ...
                  <p>
                    ...
                    exercises by selecting their name, sets, reps, and weight.
                    You can drag and drop exercises to reorder them, and
                    clicking the x icon next to an exercise will delete it. When
                    you&apos;ve finished adding exercises, select a name and
                    date for your workout and click &quot;Save&quot;.
                  </p>
                  ...
                  <p>
                    Each exercise must include a weight or at least one rep.
                    This is because you could do 10 bodyweight squats or you
                    could squat 315 pounds one time, but you can&apos;t do zero
                    reps with zero weight.
                  </p>
                </div>
              </div>
              <div id="managing-names">
                <div className="mx-auto flex max-w-sm flex-col gap-4 pt-6">
                  ...
                  <p>
                    ...
                    navigate to the settings page by clicking the gear icon in
                    the navbar. You can then update the existing names and/or
                    add new ones.
                  </p>
                  <div className="relative h-96">
                    <Image
                  ...
                  <p>
                    ...
                    saved when you navigate away from the settings page, and
                    your workout(s) will be updated accordingly.
                  </p>
                </div>
              </div>
              <div id="updating-workouts">
                <div className="mx-auto flex max-w-sm flex-col gap-4 pt-6">
                  ...
                  <p>
                    ...
                    then update the name, date, and/or exercise(s). You can
                    cancel by clicking the &quot;Discard Changes&quot; button or
                    by clicking the pencil icon again. Click save when
                    you&apos;re satisfied with your updates.
                  </p>
                  <div className="relative h-96">
                    <Image
                  ...
                  <p>
                    ...
                    indicates that the record has been broken, two means
                    it&apos;s still your record). These records will be
                    automatically refreshed any time you add, edit, or remove a
                    workout.
                  </p>
                </div>
              </div>
              <div id="tips-and-tricks">
                <div className="mx-auto flex max-w-sm flex-col gap-4 pt-6">
                  ...
                  <p>
                    Click an exercise&apos;s printout to copy its sets, reps,
                    and weight:
                  </p>
                  <div className="relative h-96">
                    <Image
                  ...
                  <p>
                    ...
                    exercise name. If you ever need help you can always return
                    to this information page by clicking the &quot;i&quot; icon
                    in the navbar. That&apos;s all you need to know, time to add
                    some workouts!
                  </p>
