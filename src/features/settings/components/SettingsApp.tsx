...
export function SettingsApp({profile}: {profile: Profile}) {
  ...
  return (
    <div className="flex min-h-screen w-full flex-grow justify-center">
      <div className="flex max-h-[calc(100dvh-56px)] w-screen flex-grow justify-center divide-x divide-slate-700 border-slate-700 bg-slate-100 dark:bg-slate-800 md:my-10 md:max-h-[calc(100dvh-136px)] md:max-w-2xl md:rounded-lg md:border lg:max-h-[calc(100dvh-80px)]">
